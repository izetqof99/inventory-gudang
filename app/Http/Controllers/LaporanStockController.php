...
class LaporanStockController extends Controller
{
    ...
    {
        return view('laporan-stok-barang.index');
    }
    ...
    public function printStok(Request $request)
    {
        ...
        // Generate PDF
        $dompdf = new Dompdf();
        $html = view('laporan-stok-barang.print-stok', compact('barangs', 'selectedOption'))->render();
        $dompdf->loadHtml($html);
        $dompdf->setPaper('A4', 'landscape');
        $dompdf->render();
        $dompdf->stream('laporan-stok-barang.pdf', ['Attachment' => false]);
    }
